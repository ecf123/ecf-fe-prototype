...
const FinishTreeNode = props => {
  const { title, locked, parentId } = props;
  ...
  return (
    <div className="finish-tree-node" id="finish">
      <div className="finish-tree-node__container">
        <img className="finish-tree-node__container__circle" src={circle} alt="Circle" data-testid="circle" />
        <img className="finish-tree-node__container__img" src={podium} alt="People celebrating" data-testid="podium" />
        {locked && <img src={lock} alt="lock" className="finish-tree-node__container__lock" data-testid="lock" />}
      </div>
      ...
      {locked && <div className="finish-tree-node__overlay" data-testid="overlay"></div>}
    </div>
  );
};
