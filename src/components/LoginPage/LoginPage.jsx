...
const LoginPage = (props) => {
  ...
  return (
    <div className='login-page'>
      ...
      <Button isSecondary={true} buttonText={<svg width="28" height="29" viewBox="0 0 28 29" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <Button isSecondary={true} />
      <Button isSecondary={true} buttonText={<svg width="24" height="29" viewBox="0 0 24 29" fill="none" xmlns="http://www.w3.org/2000/svg">
